...
## Hero scenario
1) Ingest markdown from `/docs`, `/hardware`, `/software` into Qdrant (or mock batch if Qdrant unavailable).
...
# 2) Ingest docs
python prototype/01-rag-slice/ingest.py --src ./docs ./hardware ./software \
