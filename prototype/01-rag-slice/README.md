...
# 2) Ingest docs
python prototype/01-rag-slice/ingest.py --src ./docs ./hardware ./software ./docs/assets/ai-2027 \
...
- AI-2027 snapshot (optional): drop a local PDF/HTML into `docs/assets/ai-2027` and include that path in `--src` to let the RAG demo answer safety/strategy questions from the curated corpus.
