...
- Agent Definition (product concept): `docs/specs/agent-definition.md`
- Agent Manifest: `docs/specs/agent-manifest.md`
- ITCR: `docs/specs/itcr.md`

### Axioms and data plane contracts
- Axioms and planes: `software/50-data/10-axioms-and-planes.md`
- Spine and IDs: `software/50-data/20-spine-and-ids.md`
- Plane contracts: `software/50-data/30-plane-contracts.md`
...
- Zero-copy mechanics: `software/50-data/52-zero-copy-mechanics.md`
- Schema DSL and macros: `software/50-data/53-schema-dsl-and-macros.md`
- Validation and CI (design intent): `software/50-data/80-validation-and-ci.md`

### Decisions (ADRs)
- Software decisions log: `software/90-decisions.md`
- Hardware decisions log: `hardware/90-decisions.md`

### Requirements
- Software requirements: `software/10-requirements.md`
