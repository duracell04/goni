...
1) prefer docs under `blueprint/docs/specs/` (if present)
...
- If you change scheduling/escalation semantics: update `blueprint/docs/specs/scheduler-and-interrupts.md`
- If you change tool execution/permissions: update `blueprint/docs/specs/tool-capability-api.md`
