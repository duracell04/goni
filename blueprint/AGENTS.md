...
- If you change schemas:
  ...
  - update any relevant tests in `blueprint/software/kernel/goni-schema/tests/`
...
- Regenerate AGENTS with `blueprint/scripts/generate_agents.py`.
- Validate the truth map with `blueprint/scripts/validate_truth_map.py`.
