...
> This is the technical blueprint and prototype index. It lives in `src/` so the repo root can stay non-technical; links here point to the canonical artifacts in the repo root.
...
- Agents: [docs/specs/agent-definition.md](../docs/specs/agent-definition.md)
